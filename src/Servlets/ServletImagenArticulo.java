...
@WebServlet("/ServletImagenArticulo")
public class ServletImagenArticulo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// ID Find photos
		String query = "SELECT imagen FROM \"TFG\".articulo WHERE codigo =?";
...
//		filePath = "data";
		...
		try {
			...
			PreparedStatement pstmt = con.prepareStatement("UPDATE \"TFG\".articulo SET imagen = ? WHERE codigo = ?");
